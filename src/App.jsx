...
export default function App() {
  ...
  const readDb = async (file) => {
    try {
      ...
      setDbIndex(codes); setDbKeys(keys); setDbName(file.name);
        ...
        {hasData && (
          <>
            ...
            <div className="controls">
              ...
              <button className="btn pri" disabled={!hasData} onClick={()=>downloadWorkbook(lines, includeDupes)}><Download size={15}/>Export {fmtN(exportCount)} rows</button>
            </div>
